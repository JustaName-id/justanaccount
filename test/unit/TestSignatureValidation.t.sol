...
contract TestSignatureValidation is Test, CodeConstants {
    ...
    /*//////////////////////////////////////////////////////////////
                    EIP-7702 _validateSignature TESTS
    //////////////////////////////////////////////////////////////*/

    function test_7702_ShouldValidateCorrectSignature() public {
     ...
     */
    function test_7702_ShouldFailWhenNotDelegated(uint256 nonDelegatedPk) public {
    ...
    function test_7702_ShouldFailWithOversizedSignature(uint256 signatureLength) public {
    ...
    function test_7702_ShouldRevertWithUndersizedSignature(uint256 signatureLength) public {
    ...
    function test_ShouldValidateWrappedSignatureWith7702Delegation(uint256 newOwnerPk) public {
    ...
    // function test_ShouldFailWrappedSignatureWithWrongOwnerIndex(uint256 wrongOwnerIndex, uint256 newOwnerPk) public {
    //     vm.assume(wrongOwnerIndex != 0);
    //     vm.assume(newOwnerPk > 0 && newOwnerPk < SECP256K1_CURVE_ORDER);
    //     vm.assume(newOwnerPk != TEST_ACCOUNT_PRIVATE_KEY);
        
    //     address newOwner = vm.addr(newOwnerPk);

    //     // Add NEW OWNER as owner at index 0
    //     vm.prank(TEST_ACCOUNT_ADDRESS);
    //     JustanAccount(TEST_ACCOUNT_ADDRESS).addOwnerAddress(newOwner);
    ...
    //     // Create wrapped signature with wrong ownerIndex
    //     (uint8 v, bytes32 r, bytes32 s) = vm.sign(newOwnerPk, userOpHash);
    //     bytes memory signatureData = abi.encodePacked(r, s, v);

    //     JustanAccount.SignatureWrapper memory sigWrapper = JustanAccount.SignatureWrapper({
    //         ownerIndex: wrongOwnerIndex,
    //         signatureData: signatureData
    //     });
    ...
    //     // Should fail because ownerIndex doesn't exist
    //     assertEq(validationData, SIG_VALIDATION_FAILED);
    // }
